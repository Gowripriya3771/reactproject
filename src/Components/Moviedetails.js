...
function Moviedetails() {
  ...
  return (
    <div className="container">
      <button style={{color:"white"}} onClick={() => navigate("/app")}>Back</button>
        ...
        filtermovie.map(obj =>
          <div className="main">
            ...
            <div className="second-section">
              ...
              <button onClick={()=>navigate("/player")} style={{color:"white", backgroundColor:"yellowgreen"}}>Watch Trailer</button>
